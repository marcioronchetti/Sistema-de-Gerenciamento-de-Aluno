...
$a1 = $a2 = $a3 = $media = $conceito = $disciplina ="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($disciplina_erro) && empty($a1_erro) && empty($a2_erro) && empty($a3_erro)){
        ...
        $sql = "INSERT INTO notas (cod_nota, cod_disciplina, cod_aluno, aval1, aval2, aval3, media, conceito) VALUES (null, ?, ?, ?, ?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Vincular variáveis ​​à instrução preparada como parâmetros
            mysqli_stmt_bind_param($stmt, 'iiiiiis', $param_disciplina, $param_codA, $param_a1, $param_a2, $param_a3, $param_media, $param_conceito);
            
            // Definir parâmetros
            $param_codA = $_POST["cod_aluno"];
            $param_disciplina = $_POST["disciplina"];
            $param_a1 = $a1;
            $param_a2 = $a2;
            $param_a3 = $a3;
            $param_media = $media;
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="disciplina" class="form-control" value="<?php echo $cod_disciplina;?>" id="disciplina" >
                        </div>
